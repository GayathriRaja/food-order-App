        ...
        <div id="HeaderColor">
           ...
           <nav id="navColor" className="navbar navbar-expand-lg navbar-primary ">           
                <ul class="navbar-nav">
                     ...
                     <li  class="nav-item active" onClick={onClickHomeButton} ><span height="40px" width="40px" id="one"><img id="logo"  src={LogoImage}/>FoodOrder </span> </li>  
                </ul>
                <div >
                <ul class="navbar-nav">
                     {cuisines.map(cuisine => <li  id="navColour" class="nav-link navbar-light"   onClick={onItemClick(cuisine)}> {cuisine}</li>)} 
